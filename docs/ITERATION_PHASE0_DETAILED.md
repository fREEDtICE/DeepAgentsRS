...
适用范围：本计划面向 `/Users/dafengxu/Dev/deepagents/rust/docs/ITERATION_PLAN.md#L9-9` 的 Phase 0，目标是把“最小工程骨架 + 本地工具闭环”拆解为可执行、可验收、可回归的详细迭代计划，并覆盖该阶段应固化的核心设计细节。
...
- 文档
  - Phase 0 技术设计基线：`TECH_DESIGN.md`
  - Phase 0 E2E 测试计划：`E2E_PHASE0.md`
  - 本文：Phase 0 详细迭代计划
...
- Phase 0 约束：
  ...
  - Tool 输出应尽量结构化（ls/grep/write/edit/execute），read_file 可返回 JSON string
